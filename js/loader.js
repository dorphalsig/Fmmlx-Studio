...
if (window.jQuery) {
    ...
    let scripts = [
        ...
        , "js/models/FmmlxClass.js"
        , "js/models/FmmlxValue.js"
        , "js/models/FmmlxRelationshipEndpoint.js"
        , "js/models/FmmlxAssociation.js"
        , "js/FmmlxShapes/FmmlxProperty.js"
        , "js/FmmlxShapes/FmmlxProperty.js"
        , "js/FmmlxShapes/FmmlxAssociation.js"
        , "js/controllers/StudioController.js"
    ...
    pipe.pipe(
        $.material.init(),
        console.log("Material Theme initialized"),
        window.studioController = new Controller.StudioController()
    );
