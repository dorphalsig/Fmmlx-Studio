...
FmmlxShapes.FmmlxAssociation.shape = gMake(go.Link, {
    ...
    , gMake(go.Shape, {
        toArrow: "Standard"
    }), FmmlxShapes.FmmlxAssociation._sourceRole, FmmlxShapes.FmmlxAssociation._sourceCardinality, FmmlxShapes.FmmlxAssociation._associationName, FmmlxShapes.FmmlxAssociation._targetRole, FmmlxShapes.FmmlxAssociation._targetCardinality);
